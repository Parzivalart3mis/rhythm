  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-transparent hover:bg-surface-offset text-foreground",
        ghost: "bg-transparent hover:bg-surface-offset text-foreground",
        destructive: "bg-error text-white hover:opacity-90 active:opacity-80",
      },
      size: {
        // Meets the 44px min tap target.
